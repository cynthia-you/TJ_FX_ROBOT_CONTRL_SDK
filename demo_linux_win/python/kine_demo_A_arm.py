...
'''
#计算雅可比矩阵
jts2jacb_result=kk.joints2JacobMatrix(robot_serial=0,joints=[10,20,30,40,50,60,70])
...
tag_movl=kk.movL(robot_serial=0,start_xyzabc=pose_6d_1,end_xyzabc=pose_6d_2,ref_joints=[10,20,30,40,50,60,70],vel=100,acc=100,save_path='test1.txt')
time.sleep(0.5)
print('-'*50)
