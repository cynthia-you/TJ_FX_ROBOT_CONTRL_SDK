...
#define _USER_IF_TAG_
	...
	FX_BOOL FX_Robot_PLN_MOV_TargetA_C(FX_INT32L RobotSerial, Vect6 Start_XYZABC, Vect6 End_XYZABC,
									   Vect7 Ref_Joints, FX_DOUBLE Vel, FX_DOUBLE ACC, FX_INT32L Freq, void *ret_pset);
...
FX_BOOL FX_Robot_PLN_MOVL_TargetA(FX_INT32L RobotSerial, Vect6 Start_XYZABC, Vect6 End_XYZABC,
								  Vect7 Ref_Joints, FX_DOUBLE Vel, FX_DOUBLE ACC, FX_INT32L Freq, CPointSet *ret_pset);
#endif
