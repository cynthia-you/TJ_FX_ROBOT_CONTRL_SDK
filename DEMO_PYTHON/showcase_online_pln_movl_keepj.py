...
MOVL_KEEPJ在线直线规划步骤：
    ...
    定义起点和终点的构型
    运行在线规划，用关节阻抗执行规划文件：规划点位为500HZ， 下采样为50HZ执行
...
'''
#ONLINE
points=kk.movL_KeepJA(start_joints=[0, 45, 0, -90, 0, 45, 0],
                       end_joints=[168.27022,57.70525,-21.14756,-39.81714,-156.02856,21.66079,9.95902],vel=50,acc=50)
