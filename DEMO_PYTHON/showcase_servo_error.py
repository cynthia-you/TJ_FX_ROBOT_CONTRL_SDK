...
from SDK_PYTHON.fx_robot import Marvin_Robot, DCSS,get_fault_descriptions
import time
import logging
...
error_a=robot.get_servo_error_code(arm='A')
print(f'error_a:{error_a}')

error_b=robot.get_servo_error_code(arm='B')
